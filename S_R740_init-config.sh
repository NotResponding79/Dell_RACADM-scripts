...
HDDraidFQDD6="Disk.Virtual.1:RAID.Slot.6-1"
SSDraidFQDD6="Disk.Virtual.0:RAID.Slot.6-1"
jobFQDD6="RAID.Slot.6-1"
jobFQDD8="RAID.Slot.8-1"
setupJobFQDD="BIOS.Setup.1-1"
HDDraidFQDD8="Disk.Virtual.1:RAID.Slot.8-1"
SSDraidFQDD8="Disk.Virtual.0:RAID.Slot.8-1"

## End of Variables

## Start of scripting ##

echo -e "Setting Static IP for ${BRed}$NAME${NC}...."
## Setting static IP address and disabling DHCP ##
${ECHO} "${RACADM}" setniccfg -s "${IP}" ${SUBNET} ${GW}
## Removing RAIDs and re-creating them ##
${ECHO} "${RACADM}" jobqueue delete --all
${ECHO} "${RACADM}" raid deletevd:${SSDraidFQDD6}
${ECHO} "${RACADM}" raid deletevd:${HDDraidFQDD6}
${ECHO} "${RACADM}" raid deletevd:${SSDraidFQDD8}
${ECHO} "${RACADM}" raid deletevd:${HDDraidFQDD8}
${ECHO} "${RACADM}" jobqueue create $jobFQDD6
${ECHO} "${RACADM}" jobqueue create $jobFQDD8
